...
async fn main() {
    ...
    let manager = linora::ws::WebsocketManager::new(
        linora::url::URL::Testnet,
        Some(client_private),
    )
    .await;
    let orders_id = manager
        .subscribe(
            linora::ws::Channel::Orders {
                market_symbol: None,
            },
    ...
    let order_request = OrderRequest {
        instruction: linora::structs::OrderInstruction::IOC,
        market: symbol,
        price: None,
        side: Side::BUY,

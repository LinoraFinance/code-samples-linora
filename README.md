...
Collection of linora code samples, snippets and benchmarks
...
(1) Reference: `java/linora/StarknetCurve.groovy`
...
(also referred to as linora private key).
...
To get complete understanding of this, please refer to [Onboarding & Wallets](https://docs.linora.trade/getting-started/onboarding-and-wallets) section in linora documentation.

...
def generate_linora_account_from_ledger(
    linora_config: Dict, eth_account_address: str
) -> Tuple[str, str]:
    eth_chain_id = int(linora_config['l1_chain_id'])
    stark_key_msg = build_stark_key_message(eth_chain_id)
    linora_private_key = derive_stark_key_from_ledger(stark_key_msg, eth_account_address)
